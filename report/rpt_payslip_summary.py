        ...
        for id in ids:
            ...
            if logo_bin64:
                ...
                sheet.insert_image('C1', 'Company Logo',
                                   {'image_data': logo_bytes_io, 'y_offset': 3, 'x_offset': 60, 'x_scale': 0.10,
                                    'y_scale': 0.10})
            sheet.set_row(3, 21)
            sheet.merge_range('A1:E1', '', main_header_format)
            sheet.merge_range('A2:E2', 'PAYROLL SUMMARY', main_header_format)
            sheet.merge_range('A3:E3', id.name, sub_header_format)
            ...
            sheet.write('E%s' % row, '', right_bottom_right_content_format)
